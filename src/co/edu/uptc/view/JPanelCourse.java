...
/**
 * Clase que representa el panel de visualizaci�n de cursos en la interfaz de
 * usuario. Extiende JPanelStart e incluye componentes para mostrar informaci�n
...
public class JPanelCourse extends JPanelStart {
	...
	/** The options menu. */
	private JPanel optionsMenu; // Panel para mostrar el men� de opciones

	/** The logout. */
	private JButtonTraspUPTC logout; // Bot�n para cerrar sesi�n
	 ...
	 * para la visualizaci�n del panel de curso.
	 *
	...
	/**
	 * Inicializa los combonentes con disposici�n de GridBagConstraints gbc.
	 * 
	 ...
	 *
	 * @param listener Escuchador de eventos.
	 * @param gbc      Objecto para disposici�nes.
	...
	/**
	 * A�ade los nuevos componentes al panel de la derecha.
	 * 
	...
	/**
	 * Ubica los elementos de la primera l�nea del panel de la derecha.
	 * 
	 * @param gbc      Objeto para disposiciones.
	 * @param listener Escuchador de eventos.
	 */
	...
	/**
	 * A�ade el boton de salir al panel de opciones.
	 * 
	 * @param gbc      Objeto para disposiciones.
	 * @param listener Escuchador de eventos.
	 */
	...
	/**
	 * Solo declara la etiqueta donde se mostrar� el nombre de usuario.
	 * 
	 * @param gbc Objeto para disposiciones.
	 */
	...
	/**
	 * A�ade el texto en formato html que va ir en el subtitulo del panel.
	 */
	...
	/**
	 * Agrega los componentes que van en las �ltimas posiciones. Es decir, la
	 * ventana del curso.
	 * 
	 * @param gbc Objeto para disposiciones.
	 */
